...
/**
 * ApiV1CampaignsRonCampaignIdAdsAdIdZoneBidsPutRequestZoneBidsInner Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsRonCampaignIdAdsAdIdZoneBidsPutRequestZoneBidsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns_ron__campaignId__ads__adId__zone_bids_put_request_zone_bids_inner';
    ...
    public function setBid($bid)
    {
        ...
        if (($bid < 0)) {
            throw new \InvalidArgumentException('invalid value for $bid when calling ApiV1CampaignsRonCampaignIdAdsAdIdZoneBidsPutRequestZoneBidsInner., must be bigger than or equal to 0.');
        }
