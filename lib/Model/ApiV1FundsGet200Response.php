...
/**
 * ApiV1FundsGet200Response Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FundsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_funds_get_200_response';
    ...
    protected static $setters = [
        ...
        'low_balance' => 'setLowBalance',
        'last_deposit' => 'setLastDeposit'
    ];
    ...
    protected static $getters = [
        ...
        'low_balance' => 'getLowBalance',
        'last_deposit' => 'getLastDeposit'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('min_balance', $data ?? [], null);
        $this->setIfExists('low_balance', $data ?? [], null);
        $this->setIfExists('last_deposit', $data ?? [], null);
    }
     ...
     * Sets min_balance
     *
     * @param float|null $min_balance min_balance
     *
     * @return self
     */
    public function setMinBalance($min_balance)
    {
        if (is_null($min_balance)) {
            throw new \InvalidArgumentException('non-nullable min_balance cannot be null');
        }
    ...
    {
        return $this->container['low_balance'];
    }

    /**
     * Sets low_balance
     *
     * @param bool|null $low_balance low_balance
     *
     * @return self
     */
    public function setLowBalance($low_balance)
    {
        if (is_null($low_balance)) {
            throw new \InvalidArgumentException('non-nullable low_balance cannot be null');
        }
        $this->container['low_balance'] = $low_balance;
    ...
    {
        return $this->container['last_deposit'];
    }

    /**
     * Sets last_deposit
     *
     * @param \DateTime|null $last_deposit last_deposit
     *
     * @return self
     */
    public function setLastDeposit($last_deposit)
    {
        if (is_null($last_deposit)) {
            throw new \InvalidArgumentException('non-nullable last_deposit cannot be null');
        }
        $this->container['last_deposit'] = $last_deposit;
