...
/**
 * ApiV1FiltersTypeIdItemsPost200Response Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FiltersTypeIdItemsPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_filters__type___id__items_post_200_response';
     ...
     * Sets added
     *
     * @param string[]|null $added The IDs/strings actually added (post resolution + dedupe).
     *
     * @return self
     */
