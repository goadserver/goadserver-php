...
/**
 * ApiV1CreativePoolsGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CreativePoolsGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_creative_pools_get_200_response_data_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_sizes', $data ?? [], null);
    }
     ...
     * Sets tags
     *
     * @param string|null $tags CSV of tag ids.
     *
     * @return self
     */
    ...
    {
        return $this->container['total_sizes'];
    }

    /**
     * Sets total_sizes
     *
     * @param int|null $total_sizes total_sizes
     *
     * @return self
     */
    public function setTotalSizes($total_sizes)
    {
        if (is_null($total_sizes)) {
            throw new \InvalidArgumentException('non-nullable total_sizes cannot be null');
        }
        $this->container['total_sizes'] = $total_sizes;
