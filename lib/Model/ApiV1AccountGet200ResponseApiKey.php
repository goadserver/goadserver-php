...
/**
 * ApiV1AccountGet200ResponseApiKey Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AccountGet200ResponseApiKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_account_get_200_response_api_key';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'scopes' => 'string[]',
        'resource_filter' => '\GoAdServerApi\Model\ResourceFilter'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'scopes' => 'setScopes',
        'resource_filter' => 'setResourceFilter'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'scopes' => 'getScopes',
        'resource_filter' => 'getResourceFilter'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('resource_filter', $data ?? [], null);
    }
    ...
    /**
     * Gets resource_filter
     *
     * @return \GoAdServerApi\Model\ResourceFilter|null
     */
    public function getResourceFilter()
    {
        return $this->container['resource_filter'];
    }

    /**
     * Sets resource_filter
     *
     * @param \GoAdServerApi\Model\ResourceFilter|null $resource_filter resource_filter
     *
     * @return self
     */
    public function setResourceFilter($resource_filter)
    {
        if (is_null($resource_filter)) {
            throw new \InvalidArgumentException('non-nullable resource_filter cannot be null');
        }
        $this->container['resource_filter'] = $resource_filter;
