...
/**
 * ApiV1CampaignsGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns_get_200_response_data_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('selling_type', $data ?? [], null);
    ...
    {
        return $this->container['selling_type'];
    }

    /**
     * Sets selling_type
     *
     * @param int|null $selling_type selling_type
     *
     * @return self
     */
    public function setSellingType($selling_type)
    {
        if (is_null($selling_type)) {
            throw new \InvalidArgumentException('non-nullable selling_type cannot be null');
        }
        $this->container['selling_type'] = $selling_type;
