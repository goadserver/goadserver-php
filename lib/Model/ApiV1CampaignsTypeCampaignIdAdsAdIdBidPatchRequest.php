...
/**
 * ApiV1CampaignsTypeCampaignIdAdsAdIdBidPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsTypeCampaignIdAdsAdIdBidPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns__type___campaignId__ads__adId__bid_patch_request';
    ...
    public function setBid($bid)
    {
        ...
        if (($bid < 0)) {
            throw new \InvalidArgumentException('invalid value for $bid when calling ApiV1CampaignsTypeCampaignIdAdsAdIdBidPatchRequest., must be bigger than or equal to 0.');
        }
