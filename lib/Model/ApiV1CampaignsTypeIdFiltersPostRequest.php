...
/**
 * ApiV1CampaignsTypeIdFiltersPostRequest Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsTypeIdFiltersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns__type___id__filters_post_request';
    ...
    public const FILTER_TYPE_DOMAIN_EXCL = 'domain_excl';
    public const FILTER_TYPE_ADZONE_EXCL = 'adzone_excl';
    public const FILTER_TYPE_ISP_EXCL = 'isp_excl';
    public const FILTER_TYPE_SUBID_EXCL = 'subid_excl';
    public const FILTER_TYPE_DOMAIN_INCL = 'domain_incl';
    public const FILTER_TYPE_ADZONE_INCL = 'adzone_incl';
    public const FILTER_TYPE_SUBID_INCL = 'subid_incl';
    ...
    {
        return [
            self::FILTER_TYPE_DOMAIN_EXCL,
            self::FILTER_TYPE_ADZONE_EXCL,
            self::FILTER_TYPE_ISP_EXCL,
            self::FILTER_TYPE_SUBID_EXCL,
            self::FILTER_TYPE_DOMAIN_INCL,
            self::FILTER_TYPE_ADZONE_INCL,
            self::FILTER_TYPE_SUBID_INCL,
        ];
    }
