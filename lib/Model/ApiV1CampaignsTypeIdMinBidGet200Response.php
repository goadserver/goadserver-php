...
/**
 * ApiV1CampaignsTypeIdMinBidGet200Response Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsTypeIdMinBidGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns__type___id__min_bid_get_200_response';
     ...
     * Sets campaigns
     *
     * @param string|null $campaigns Minimum bid as a fixed-decimal string (legacy panel format).
     *
     * @return self
     */
