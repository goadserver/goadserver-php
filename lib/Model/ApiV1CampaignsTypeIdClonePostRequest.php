...
/**
 * ApiV1CampaignsTypeIdClonePostRequest Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsTypeIdClonePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns__type___id__clone_post_request';
     ...
     * Sets name
     *
     * @param string|null $name Override the cloned campaign's name. Defaults to \"<original> Copy\".
     *
     * @return self
     */
