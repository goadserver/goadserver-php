...
/**
 * ApiV1UrlPoolsIdUrlsUrlIdWeightPutRequest Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1UrlPoolsIdUrlsUrlIdWeightPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_url_pools__id__urls__urlId__weight_put_request';
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight < 1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling ApiV1UrlPoolsIdUrlsUrlIdWeightPutRequest., must be bigger than or equal to 1.');
        }
