...
/**
 * ApiV1CampaignsTypeIdBidsPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  GoAdServerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1CampaignsTypeIdBidsPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_campaigns__type___id__bids_patch_request';
    ...
    public const MODE_PCT_INC = 'pct_inc';
    public const MODE_PCT_DEC = 'pct_dec';
     ...
     * Sets value
     *
     * @param float|null $value Required when mode=set. New absolute bid (>= 0).
     *
     * @return self
     */
     ...
     * Sets pct
     *
     * @param float|null $pct Required when mode=pct_inc / pct_dec. Percent change (> 0).
     *
     * @return self
     */
     ...
     * Sets ad_ids
     *
     * @param int[]|null $ad_ids Optional. Subset of ad ids to update. Omit/empty for \"all ads\".
     *
     * @return self
     */
